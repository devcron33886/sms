...
@section('content')
    @can('testimonial_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('hod.testimonials.create') }}">
                            ...
                            <td>
                                @can('testimonial_show')
                                    <a class="btn btn-xs btn-primary"
                                       href="{{ route('hod.testimonials.show', $testimonial->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('testimonial_delete')
                                    <form action="{{ route('hod.testimonials.destroy', $testimonial->id) }}"
