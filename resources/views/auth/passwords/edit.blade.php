            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("profile.password.updateProfile") }}">
                        ...
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.user.fields.mobile') }}</label>
                            <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="tel"
                                   name="mobile" id="mobile" value="{{ old('mobile', auth()->user()->mobile) }}"
                                   required>
                        ...
                        <div class="form-group">
                            <label class="required" for="class">{{ trans('cruds.user.fields.class') }}</label>
                            <input class="form-control {{ $errors->has('class') ? 'is-invalid' : '' }}" type="text"
                                   name="class" id="class" value="{{ old('class', auth()->user()->class) }}" required>
                            @if($errors->has('class'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('class') }}
                                </div>
