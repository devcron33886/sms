...
class TestimonialController extends Controller
{
    public function index()
    {
        ...
        return view('hod.testimonials.index', compact('testimonials'));
    }
    ...
    public function create()
    {
        ...
        return view('hod.testimonials.create', compact('users'));
    }
    ...
    public function store(StoreTestimonialRequest $request)
    {
        ...
        return redirect()->route('hod.testimonials.index');
    }
    ...
    public function edit(Testimonial $testimonial)
    {
        ...
        return view('hod.testimonials.edit', compact('users', 'testimonial'));
    }
    ...
    public function show(Testimonial $testimonial)
    {
        ...
        return view('hod.testimonials.show', compact('testimonial'));
    }
