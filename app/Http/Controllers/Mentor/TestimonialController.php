...
class TestimonialController extends Controller
{
    public function index()
    {
        ...
        return view('mentor.testimonials.index', compact('testimonials'));
    }
    ...
    public function create()
    {
        ...
        return view('mentor.testimonials.create', compact('users'));
    }
    ...
    public function store(StoreTestimonialRequest $request)
    {
        ...
        return redirect()->route('mentor.testimonials.index');
    }
    ...
    public function edit(Testimonial $testimonial)
    {
        ...
        return view('mentor.testimonials.edit', compact('users', 'testimonial'));
    }
    ...
    public function show(Testimonial $testimonial)
    {
        ...
        return view('mentor.testimonials.show', compact('testimonial'));
    }
